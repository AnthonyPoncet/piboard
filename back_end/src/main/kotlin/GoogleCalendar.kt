...
class GoogleCalendar : Loader {
    companion object {
        private val APPLICATION_NAME = "Google Calendar for PiBoard"
    ...
    override suspend fun load(dataManager: DataManager) {
        ...
        dataManager.setCalendar(events.items.map {
            event -> Event(
